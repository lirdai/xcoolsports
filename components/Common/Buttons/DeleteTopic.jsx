...
const DeleteTopic = ({ id, commentDelete, navigation, onClose }) => {
  const { t, i18n } = useTranslation();
  const theme = useContext(ThemeContext);

  const [deleteTopic] = api.endpoints.deleteTopic.useMutation();
      ...
      >
        <View style={styles.modalContainer}>
          ...
          <View style={styles.modalContent}>
            ...
            <Pressable hitSlop={10} style={styles.modalButton} onPress={handleDeleteTopic} onLongPress={() => Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light)}>
